...
SHOW_LIST = ['MPC_iLQR_cp_', 'RLi_cp_']
...
def name_change(curr_name):
	...
	elif curr_name == "MPC_iLQR_cp_":
		return r"iLQR_cp", new_palette[-3], '--'
	elif curr_name == "RLi_cp_":
		return r"DRL_cp", new_palette[-2], '-'
	# elif curr_name == "MPCl":
	# 	return r"MPC$^{(p)}$"
